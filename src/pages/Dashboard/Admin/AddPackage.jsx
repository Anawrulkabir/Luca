...
const AddPackage = () => {
  ...
  const [daysPlan, setDaysPlan] = useState([
    { title: '', details: '', stock: '', price: '' },
  ])

  const handleDaysPlanChange = (index, field, value) => {
    const newDaysPlan = [...daysPlan]
    newDaysPlan[index][field] = value
                          ...
                          <TableRow key={index}>
                            ...
                            <TableCell>
                              ...
                              <Input
                                id={`title-${index}`}
                                type="text"
                                value={daysPlan[index]?.title || ''}
                                onChange={(e) =>
                                  handleDaysPlanChange(
                                    index,
                                    'title',
                                    e.target.value
                                  )
